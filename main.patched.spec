...
a = Analysis(
    ...
    datas=[('gui/components/examples/*.gif', 'gui/components/examples'),
        ('icon.png', '.'),('core/pdf_worker.py', 'core'),('assets/quill/*', 'assets/quill'),('qtwebengine_dictionaries/*', 'qtwebengine_dictionaries'),('assets/default_english.json', 'assets'),('core/analysis_templates.json','core'),('assets/opendeck/*', 'assets/opendeck'),('web/frontend/dist', 'web/frontend/dist')],
    hiddenimports=[
...
def apply_pyarmor_patch():
    ...
    srcpath = ['/home/sunbear/Desktop/PDF_App']
    obfpath = '/home/sunbear/Desktop/PDF_App/.pyarmor/pack/dist'
