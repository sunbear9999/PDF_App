...
a = Analysis(
    ...
    datas=[('gui/components/examples/*.gif', 'gui/components/examples'),
        ('icon.png', '.'),('core/pdf_worker.py', 'core'),('assets/quill/*', 'assets/quill'),('qtwebengine_dictionaries/*', 'qtwebengine_dictionaries'),('assets/default_english.json', 'assets'),('core/analysis_templates.json','core'),('assets/opendeck/*', 'assets/opendeck')],
